...
public class Dimension extends BoundedSpaceElement
{
	...
	/**
	 * Gets the orientation of the dimension. The dimension is <code>X</code> or
	 * <code>Y</code>.
	 * 
	 * @return int
	 */
	public int getOrientation()
	{
		...
		else
		{
			throw new IllegalStateException(
					"parent dimension does not belong to a scale");
		}
	}
	...
	{
		String orientation = getOrientation() == ORIENTATION_X ? "horizontal"
				: "vertical";
