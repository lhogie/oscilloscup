...
public class Legend extends SpaceElement
{
	...
	public void draw(Graphics2D graphics)
	{
		...
		graphics.translate(graphics.getClipBounds().getWidth() / 2,
				graphics.getClipBounds().getHeight() / 2);

		// if the legend is the Y dimension legend, it has to be rotated
		if (getParent() instanceof Dimension && ((Dimension) getParent()).getParentSpace()
